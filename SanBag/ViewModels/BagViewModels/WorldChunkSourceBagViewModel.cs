...
{
    public class WorldChunkSourceBagViewModel : GenericBagViewModel
    {
        ...
        {
            return record.Info?.Resource == FileRecordInfo.ResourceType.WorldChunkSource &&
                   record.Info?.Payload == FileRecordInfo.PayloadType.Payload;
        }

        protected override void CustomFileExport(ExportParameters exportParameters)
        {
            var Blueprint = WorldChunkSource.Create();
        ...
        {
            var view = CurrentResourceView.DataContext as WorldChunkSourceViewModel;
            if (view == null)
            {
                return;
            }
